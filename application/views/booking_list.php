                     ...
                     <table id="example" class="table table-bordered" style="width:100%">                     
                      ...
                      ?>
                        ...
                        <tr id="tr_<?php echo $row->id;?>">                           
                            ...
                            <br><small class="text-success">Create By: <?php echo $row->create_by;?></small>
                            <!--br><a href="javascript:void(0);" class="text-danger">New link request</a-->

                            <?php 
                              if($row->link_request == 1)
                              {
                                echo '<br><span class="link_request text-danger">New Link Request</span>';
                              }
                            ?>
                          </td>
...
$(document).ready(function(){
 ...
 /**----Blink Text-------*/ 
  function blink_text() {
      $('.link_request').fadeOut(500);
      $('.link_request').fadeIn(500);
  }
