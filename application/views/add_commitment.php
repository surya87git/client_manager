                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1 text-primary" style="text-decoration:underline;">Ajay Jain</h4>                               
                                </div><!-- end card header -->
                                <div class="card-body">
                                    <div class="live-preview">
                                        <div class="row gy-4">
                                                <div class="d-flex align-items-center">
                                                    <h5 class="card-title flex-grow-1 mb-0 text-primary" style="text-decoration: underline;">
                                                        Select for Commitment from following List
                                                    </h5>
                                                </div>   
                                        <form id="frmCommit">
                                            <div class="row mt-3">                         
                                                ...
                                                <!--div class="col-md-3 mt-3">
                                                    <div>                                                      
                                                        <div>
                                                            ...
                                                            <input type="number" id="sba" name="sba" value="<?php echo $sba_data;?>" class="form-control" placeholder="SBA" require>
                                                        </div>
                                                    </div> 
                                                </div>
                                                <div class="col-md-3 mt-3">
                                                   <div>                                                      
                                                      <div>
                                                         <label for="est_cost" class="form-label">Project Estimate</label>
