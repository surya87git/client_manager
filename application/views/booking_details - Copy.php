        ...
        <div class="row">
          <div class="col-xl-9">
            ...
            <div class="card">
              <div class="card-header">
                <div class="d-sm-flex align-items-center">
                  <h5 class="card-title flex-grow-1 mb-0">Payeer</h5><button type="button" class="btn btn-success btn-sm btn-label waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#zoomInModalpayee"><i class=" ri-edit-2-fill label-icon align-middle fs-16 me-2"></i>Edit</button>
                </div>
              </div>
              <div class="card-body">
                <div class="row">
            ...
            <div class="card">
              <div class="card-header">
                <h5 class="card-title mb-0">
                  <i class="ri-map-file-line align-middle me-1 text-muted"></i> Attached Document 
                </h5>
              </div>
              <div class="card-body">
                  <?php
              ...
              <div class="card-header">
                ...
                <div class="row mt-3">
                  <div class="col-md-4">
                    <div>
                        <div class="icheck-success d-inline">
                          <input type="checkbox"  class="switcher"  name="req[]" value="Client" id="Client">
                          <label title="Checked" for="Client" id="">By Client</label>
                        </div> <br>                   
                        <small>Date: 12/03/2023</small>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div>
                          <div class="icheck-success d-inline">
                            <input type="checkbox"  class="switcher"  name="req[]" value="Marketing" id="Marketing">
                            <label title="Checked" for="Marketing" id="">By Marketing</label>
                          </div> <br> 
                       <small>Date: 12/03/2023</small>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div>
                          <div class="icheck-success d-inline">
                            <input type="checkbox"  class="switcher"  name="req[]" value="Admin" id="Admin">
                            <label title="Checked" for="Admin" id="">By Admin</label>
                          </div>
                          <br> 
                          <small>Date: 12/03/2023</small>
                    </div>
                  ...
                  <div class="modal-content">
                      ...
                      <form id="frmPayee">
                        <div class="row">
                          ...
                          <div class="col-xl-6 mt-2">                         
                            <input type="text" id="p_mobile_no" name="p_mobile_no" value="<?php echo $payee[0]->p_mobile_no; ?>" class="form-control" placeholder="Mobile Number">
                          </div>               
                          <div class="col-xl-6 mt-2">                         
                            <input type="email" id="p_email_id" name="p_email_id" value="<?php echo $payee[0]->p_email_id; ?>" class="form-control" placeholder="Enter Email">
                          </div>
                          <div class="col-xl-6 mt-2">                         
                            <input type="text" id="p_relation" name="p_relation" value="<?php echo $payee[0]->p_relation; ?>" class="form-control" placeholder="Enter Relation">
                          </div>                       
                          <div class="col-xl-6 mt-2">                         
                            <input type="text" id="p_pan_no" name="p_pan_no" value="<?php echo $payee[0]->p_pan_no; ?>" class="form-control" placeholder="Enter Pan Number">
                          </div>
                          <div class="col-xl-6 mt-2">                         
                            <input type="text" id="p_aadhar_no" name="p_aadhar_no" value="<?php echo $payee[0]->p_aadhar_no; ?>" class="form-control" placeholder="Enter Adhaar Card">
                          </div>
                          <span class="mt-2">Address</span>
                          <div class="col-xl-12 mt-2">                         
                            <input type="text" id="p_hno" name="p_hno" value="<?php echo $p_addr_arr['p_hno']?>"  class="form-control" placeholder="House Number">
                          </div>
                          <div class="col-xl-12 mt-2">                         
                            <input type="text" id="p_street" name="p_street" value="<?php echo $p_addr_arr['p_street']?>" class="form-control" placeholder="Street Number">
                          </div>
                          <div class="col-xl-6 mt-2">                         
                            <input type="text" id="p_landmark" name="p_landmark" value="<?php echo $p_addr_arr['p_landmark']?>" class="form-control" placeholder="Enter Landmark">
                          </div>
                          <div class="col-xl-6 mt-2">                         
                            <input type="text" id="p_city" name="p_city" value="<?php echo $p_addr_arr['p_city']?>" class="form-control" placeholder="Enter City">
                          </div>
                          <div class="col-xl-6 mt-2">                         
                            <input type="text" id="p_state" name="p_state" value="<?php echo $p_addr_arr['p_state']?>" class="form-control" placeholder="Enter State">
                          </div>
                          <div class="col-xl-6 mt-2">                         
                            <input type="number" id="p_pincode" name="p_pincode" value="<?php echo $p_addr_arr['p_pincode']?>" class="form-control" placeholder="Enter Pin Code">
                          </div>   
                        </div>
                        <div class="modal-footer">
                        <input type="hidden" name="booking_id" value="<?php echo $client_info[0]->id ?? ""; ?>">
              ...
              <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                      ...
                      <form>
                        ...
                        <div class="modal-footer">
                          <input type="hidden" name="booking_id" value="<?php echo $client_info[0]->id ?? ""; ?>">
                          <input type="hidden" name="plot_id" value="<?php echo $trans_detail[0]->id ?? ""; ?>">
