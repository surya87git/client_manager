            ...
            <div class="card">
              <div class="card-header">
                <div class="d-flex justify-content-between">
                    <h4 class="card-title mb-0">Column Details</h4><a href="<?php echo base_url("index.php/anubandh/columnlist");?>" class="btn btn-primary btn-sm">Column List</a>
                </div>  
              </div>
              <div class="card-body">
                <form id="frmColumn">
                  <div class="live-preview">
                    ...
                    <div class="mt-3" style="float: right;">
                      <a href="payment_plan_list.php" class="btn btn-secondary" id="btn_cancel">Cancle</a>
...
$('#frmColumn').validate({
      ...
      submitHandler: function(form) {
        ...
        var url = "ajax_anubandh_column.php"; 
        $.ajax({
          type: "POST",
          url: url,
          ...
          success: function(data) {
            ...
            if (spl_txt[1] == 1) {
              alert(spl_txt[2]);
              //window.location.href = "payment_plan_list.php";
            } else {
              //alert(spl_txt[2]);
            }
          }
...
</script> <?php echo include("footer.php");?>