                ...
                <div class="row mt-3">
                  ...
                  <div class="col-md-3">
                    <span>Booking Confirmation Mail</span><br>
                      ...
                      <div id="div_mail_2">
                        <a href="javascript:void(0);" <?php if($chk_trans != "checked"){ echo 'disabled="disabled"';}?> id="btnMail_2" mid="<?php echo $client_info[0]->id ?? ""; ?>" style="margin-top: 5px;" class="btn btn-danger btn-sm  btn-label waves-effect waves-light"><i class=" ri-mail-fill label-icon align-middle fs-16 me-2"></i>Send Now</a>
                      </div>
