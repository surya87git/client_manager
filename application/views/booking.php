                                            ...
                                            <div id="custom-progress-bar" class="progress-nav mb-4">
                                                ...
                                                <ul class="nav nav-pills progress-bar-tab custom-nav" role="tablist">
                                                    <li class="nav-item" role="presentation">
                                                        <button class="nav-link rounded-pill active" data-progressbar="custom-progress-bar" id="pills-info-desc-tab" data-bs-toggle="pill" data-bs-target="#pills-info-desc" type="button" role="tab" aria-controls="pills-info-desc" aria-selected="false">1</button>
                                                    </li>
                                                    <li class="nav-item" role="presentation">
                                                        <button class="nav-link rounded-pill" data-progressbar="custom-progress-bar" id="pills-success-tab" data-bs-toggle="pill" data-bs-target="#pills-success" type="button" role="tab" aria-controls="pills-success" aria-selected="false">2</button>
                                                    </li>
                                                </ul>
                                            </div>                                        
                                            <!-- Start tab content -->
                                            <div class="tab-content">
                                                <!-- Start of plan 1 tab pane -->
                                                    <div class="tab-pane fade show active" id="pills-info-desc" role="tabpanel" aria-labelledby="pills-info-desc-tab">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <ul class="text-primary">
                                                                    <li>Naksha Pass Process will Start</li>                            
                                                                </ul>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <ul class="text-primary">
                                                                    <li>Front Elevation will start</li>                            
                                                                </ul>
                                                            </div>        
                                                        </div>
                                                        <center>
                                                            <h3 class="text-danger" style="font-weight: bold;">Total ₹ 3,00,000/-</h3>
                                                        </center>
                                                        <center>
                                                            <div class="">
                                                ...
                                                <div class="tab-pane fade" id="pills-success" role="tabpanel" aria-labelledby="pills-success-tab">
                                                        ...
                                                        <div class="mt-5" style="text-align: center;">
                                                            <h2 class="text-primary" style="font-weight: bold;">35 % of Total cost of the Project ₹ <span id="total_cost_html">0</span>/-</h2>
                                                        </div>
                                                    <center><h3 class="text-danger">Total ₹ <span id="total_percent_html">0</span>/-</h3></center>
                                                    <div class="d-flex align-items-start gap-3 mt-4">
                                                        ...
                                                        <a href="javascript:void(0);" id="total_percent_a" price="" class="btn_booking btn btn-success  center ms-auto">Submit</i></a>
                                                    </div>
                                                </div>
                                                <!-- end tab pane -->
                                            </div>
...
<div class="row" id="client_panel" style="display: none;">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                           <span class="text-primary">Please Import data from Cost Calculator for more efficeincy</span> <button type="button" class="btn btn-success btn-sm btn-label waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#myModal" style="float:right;"> Import<i class=" ri-download-2-fill label-icon align-middle "></i></button>
                        </div>
                    </div>      
                </div>
    ...
    <div class="col-lg-8">
        ...
        <div class="d-flex align-items-start gap-3 mt-4">    
            ...
            <input type="hidden" id="total_percent" name="total_percent">
...
<div id="myModal" class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="myModalLabel">
            ...
            {                 
                ...
                else
                {
                    ...
                    $.each(res, function(key,val) { 
                        ...
                        /*$.get(val.create_date, function(data) {
                        date = new Date(data);
                        console.log(date);  
                        });
  ...
  $(document).on("click", ".data_row", function(){           
       ...
       $.ajax({    
            ...
            {           
               ...
               $("#total_cost").val(Math.ceil(res[0].total_cost));
               $("#total_cost_html").html(Math.ceil(res[0].total_cost));

                var tc = res[0].total_cost;
                var tp = Math.ceil(tc/100*35);
                $("#total_percent_html").html(tp);
                $("#total_percent").val(tp);
                $("#total_percent_a").attr("price", tp);
