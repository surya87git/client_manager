                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">Initial Booking Details</h4>
                                </div><!-- end card header -->
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <button type="button" class="btn btn-success btn-label waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#myModal" style="float:right;"> Import<i class=" ri-download-2-fill label-icon align-middle "></i></button>
                    </div>
                </div>      
            </div>
                            ...
                            <div class="modal-body">
                              <div class="col-lg-12 col-md-12">
                                  ...
                                  <table class="table table-nowrap">
                                      ...
                                      <tbody id='tr_data'>
                                          <!--tr>
                                            <th scope="row"><a href="#" class="fw-semibold">Surya Narayan</a></th>
                                            <td>1000 Sqft</td>
                                            <td>4th Floor</td>
                                            <td>Rs. 50,000</td>                                             
                                          </tr>
 ...
 <div class="col-lg-8">
    ...
    <form id="frmClientInfo">
        ...
        <div class="d-flex align-items-start gap-3 mt-4">    
            ...
            <input type="submit" value="Save on Draft" class="btn btn-success" data-nexttab="v-pills-bill-address-tab">
            <button type="submit" class="btn btn-success btn-label right ms-auto nexttab nexttab" data-nexttab="v-pills-bill-address-tab"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Go to Decision Maker</button>
        </div>
...
<!--------------Start Decision Maker------------------------------->
            ...
            <div class="tab-pane fade show " id="v-pills-bill-address" role="tabpanel" aria-labelledby="v-pills-bill-address-tab">
                ...
                <div class="col-sm-12">
                    ...
                    <label class="text-primary" for="client_info">Same as Client Information</label>
                </div>
                <br>
                <div>
                <form id="frmDecMaker">
             ...
             <div class="d-flex align-items-start gap-3 mt-4">
                ...
                <button type="submit" class="btn btn-success btn-label right ms-auto nexttab nexttab" data-nexttab="v-pills-payment-tab"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Go to Payer</button>
             </div>
        </form>
    </div>
    ...
    <!-------END Desigion Maker------------------->
            ...
            <div class="tab-pane fade" id="v-pills-payment" role="tabpanel" aria-labelledby="v-pills-payment-tab">
                ...
                <div class="col-sm-12">
                    <input type="checkbox" class="form-check-input" id="client_info1">
                    <label class="text-primary" for="client_info">Same as Client Information</label>
                </div>
                <br>
                <div>
                <form id="frmPayee">                        
                    <div class="row gy-3">                        
                        ...
                        <div class="col-6">
                            <label for="relation" class="form-label">Relation</label>
                            <input type="text" id="p_relation" name="p_relation" value="" class="form-control"  placeholder="Enter relation" require>
                        </div>
                        <div class="col-sm-6">
                            <label for="mobile" class="form-label">Mobile Number</label>
                            <input type="number" id="p_mobile_no" name="p_mobile_no" value="" class="form-control"  placeholder="Enter Number" require>
                        </div>
                        <div class="col-sm-6">
                            <label for="email" class="form-label">Email</label>
                            <input type="email" id="p_email_id" name="p_email_id" value="" class="form-control"  placeholder="Enter email" require>
                        </div>
                        <div class="col-sm-6">
                            <label for="pan_number" class="form-label">Pan Number</label>
                            <input type="text" id="p_pan_no" name="p_pan_no" value="" class="form-control"  placeholder="Enter PAN Number" require>
                        </div>
                        <div class="col-sm-6">
                            <label for="aadhar_number" class="form-label">Aadhar Number</label>
                            <input type="number" id="p_aadhar_no" name="p_aadhar_no" value="" class="form-control"  placeholder="Enter Aadhar Number" require>
                        </div>
                        <div class="col-sm-6">
            ...
            <div class="d-flex align-items-start gap-3 mt-4">
                ...
                <button type="submit" class="btn btn-success btn-label right ms-auto nexttab nexttab" data-nexttab="v-pills-acd-tab"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Account Details</button>
            </div>
            </form>
            </div>
            <!-- end tab pane -->
                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <label for="" class="form-label">Payment Mode</label>
                                <div class="my-2">
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="cash" name="payment_mode" class="form-check-input" >
                                        <label class="form-check-label" for="cash">Cash</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="chk_upi" name="payment_mode" class="form-check-input" >
                                        <label class="form-check-label" for="UPI">UPI</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="chk_neft" name="payment_mode" class="form-check-input" >
                                        <label class="form-check-label" for="neft">NEFT/RTGS/IMPS</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="chk_cards" name="payment_mode" class="form-check-input" >
                        ...
                        <div class="my-2">  
                            <div class="form-check form-check-inline">                        
                                <input type="radio" id="self" name="funding_mode" class="form-check-input">
                                <label class="form-check-label" for="self">Self</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input type="radio" id="bank" name="funding_mode" type="radio" class="form-check-input">
                                <label class="form-check-label" for="bank">Bank</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input type="radio" id="both" name="funding_mode" class="form-check-input">
            ...
            <div class="tab-pane fade" id="v-pills-pd" role="tabpanel" aria-labelledby="v-pills-pd-tab">
                ...
                <form id="frmPlot" method="post" enctype="multipart/form-data">                        
                    ...
                    <!--div class="col-sm-6">
                        ...
                        <input type="submit" name="submit" id="btn_plot" value="Save on Draft" class="btn btn-success">
                    </div-->
            ...
            <div class="d-flex align-items-start gap-3 mt-4">
              ...
              <button type="submit" name="submit" id="btn_plot" class="btn btn-success btn-label right ms-auto nexttab nexttab" data-nexttab="v-pills-ad-tab"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Attach Document</button>
            </div>                        
        </from>   
        </div>
                ...
                <div>               
                    ...
                    <form id="frmDoc" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="submit" name="submit" id="btn_doc" value="Save on Draft" class="btn btn-success">
                        </div>
...
<!-- end row -->
    ...
    <footer class="footer">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                <b>Copyright <script>document.write(new Date().getFullYear())</script> © <a hrf="https://www.ukcdesigner.in/">UKConcept Designer</a></b> All rights reserved.
                </div>
                <div class="col-sm-6">
        ...
        $.ajax({
            ...
            { 
                ...
                if(spl_txt[1] == 1)
                {
                    ...
                    $("#v-pills-bill-info-tab").removeClass('active');
                    $("#v-pills-bill-address-tab").addClass('active');
