...
SELECT a.id, a.booking_id, a.create_date AS aggr_date, b.client_name, b.mobile_no, b.email_id, c.work_start_on AS start_date, c.comp_period AS end_date FROM bkf_aggrement_form a LEFT JOIN bkf_booking_form b ON a.booking_id = b.id LEFT JOIN bkf_commitment c ON  a.booking_id = c.booking_id WHERE a.status = 1
