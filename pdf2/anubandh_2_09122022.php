...
$html.= '<div class="head">
          <img src="logo.png" alt="" height="110px" width="110px" style="padding:0px;">    
          <h4 style="padding:0px;">UK Concept Designer - Estimate</h4>
...
foreach($fcost_array as $k => $fcost)
{
  ...
  $html .='<tr><td colspan="2"><span style="font-size: 16px; font-weight:bold;">'.$floor.' Cost:- ₹ '.number_format($final_floor_cost).'</span></td></tr>';  
  $c++;
